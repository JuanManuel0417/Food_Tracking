    ...
    <nav class="menu_navegacion">
        ...
        <ul type="none" class="Contenidos">
            ...
            <a href="#">
                <div class="Paris">
                    <li>
                        <img src="Assets/img/Ahuyama.jpg" alt="" width="125%" height="250px" class="img_1">
                        <h3>Sopa De Ahuyama</h3>
        ...
        <div class="contenedor-chat" id="contenedorChat" style="display: none;">
            <div class="caja-chat">
                ...
                <div class="visualizacion-chat" id="visualizacionChat">
                    <div class="mensaje-chat mensaje-bot">Hola, es un placer atenderte hoy. Por favor, escribe una opción para que pueda ayudarte. <br><br>
                    1: Me gustaría saber, ¿qué es Food Tracking?<br>
                    2: ¿Cómo puedo ser beneficiario del programa de vaso de leche o del restaurante escolar?<br>
                    3: </div>
                </div>
